 ...
 *版本:  1.8
 */
public class SousuoGrade extends JFrame {
    ...
    public SousuoGrade(String name,String classname){
        super("搜索成绩");
        tablepaint(name, classname);
        Init();
    ...
    public void tablepaint(String name,String classname) {
        ...
        String sql = "SELECT * FROM grade where name = '"+name+"' and class = '"+classname+"'";
        try {
